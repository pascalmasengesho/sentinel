...
6. The release workflow publishes the PyPI distribution with Trusted Publishing, creates a GitHub Release with wheel, sdist, and AUR recipe assets, and release-tag workflows build the container and Snap artifact.
